<template>
    <div class="player" v-show="playlist.length>0">
      ...
      <audio :src="currentSong.url" @ended="end" ref="audio" @play="ready" @error="error" @timeupdate="updateTime"></audio>
    </div>
</template>
...
<script type="text/ecmascript-6">
  ...
  import ProgressCircle from '../../base/psogress-circle/progress-circle.vue'
